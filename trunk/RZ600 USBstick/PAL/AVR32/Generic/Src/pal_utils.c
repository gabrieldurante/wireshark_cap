 ...
 * @file pal_utils.c
 *
 * @brief Utilities for PAL for AVR32 MCUs
 *
 * This file implementes utilities for the PAL module for AVR32 MCUs.
 *
 * $Id: pal_utils.c 25260 2011-01-31 05:03:17Z yogesh.bellan $
 *
