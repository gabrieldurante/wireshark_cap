...
#define ACK_ID                  0x35
#define ACK_REQUEST_ID          0x36
#define QUERY_REQUEST_ID        0x37
#define QUERY_RESPONSE_ID       0x38
#define RESULT_SUCCESS          0x00
#define RESULT_FAILURE          0x01
#define RESULT_INVALID_CH       0x02
#define RESULT_CAPTURING        0x03
#define RESULT_NO_CAPTURING     0x04
#define RESULT_POSITION         4
#define CHECKSUM_POSITION       6
#define BAND_868_MHZ_BPSK       0x01
#define BAND_900_MHZ_BPSK       0x02
#define BAND_2400_MHZ_OQPSK     0x04
#define INCL_RSSI               1

/* === Prototypes =========================================================== */
void parse_gui_cmd(uint8_t *sio_rx_data, uint8_t number_of_gui_cmd_bytes);
void handle_received_gui_cmd(uint8_t *cmd_buf);
