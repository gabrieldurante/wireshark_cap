 ...
 * @file pal_config.h
 *
 * @brief PAL configuration for AT90USB1287
 *
 * This header file contains configuration parameters for AT90USB1287.
 *
 * $Id: pal_config.h 29523 2011-11-25 07:33:27Z yogesh.bellan $
 *
...
/*
 * Sleep Transceiver pin is PORTB 3
 */
#define SLP_TR                          (PINB4)
#define SLP_TR_PORT                     (TRX_PORT1_ID)

/*
 * RESET pin is PORTB 1
 */
#define RST                             (PINB5)
...
#define LED_PORT_LED_2                  (PORTE)
#define LED_PORT_DIR_LED_2              (DDRE)
#define LED_PORT_LED_3                  (PORTE)
#define LED_PORT_DIR_LED_3              (DDRE)

/*
 * PINs where LEDs are connected
 */
#define LED_PIN_0                       (PIND7)
#define LED_PIN_1                       (PIND5)
#define LED_PIN_2                       (PINE7)
#define LED_PIN_3                       (PINE6)
...
/*
 * TRX Access macros for AT90USB1287
 */
...
#define TRX_INIT()                      do {                        \
     ...
     * For Example for AT90USB1287, FOSC = 8Mhz                            \
